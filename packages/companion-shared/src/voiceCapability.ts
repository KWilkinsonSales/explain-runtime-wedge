// Pure, DOM-independent browser voice-capability detection and error
// classification. Shared by Companion (companionRuntime) and ExplainIT
// (voiceCapture) so both products gate mic/speech access, and describe its
// failures, identically — one capability detector, not two.
...
// human-readable VOICE_UNAVAILABLE_MESSAGES copy, only alongside it, so
// neither product ever hides what actually happened.
