...
as of 2026-07-14 after Command 3: contract-level tests live in
...
`proof/durin/browser-walkthrough.mjs` (C3); retrieval (C4) tests are specified
here and land in Command 4.
